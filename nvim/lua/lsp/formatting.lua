...
require("conform").setup({
	-- NOTE: ensure the formatter is added to to the ensure_installed list below
	formatters_by_ft = {
		lua = { "stylua" },
	...
	formatters = {
		...
		biome = {
			require_cwd = true,
			cwd = require("conform.util").root_file(biome_markers),
		},
	},
	default_format_opts = {
		lsp_format = "fallback",
...
vim.keymap.set({ "n", "v" }, "<leader>ci", "<cmd>ConformInfo<cr>", { desc = "Conform Info" })
...
-- taken from 'https://tduyng.com/blog/neovim-formatter-conform/'
